...
export default function AddEmployeeModal({open,setOpen}) {
    ...
    return (
        <div>
            ...
            >
                <Box sx={{ ...style }}>
                    <Typography sx={{ margin: '10px 0 0 0px', fontSize: '24px' }}>Add New Staff</Typography>
                    <PersonalInfo />
                    <AccountDetail />
        ...
        <React.Fragment>
            ...
            >
                <Box sx={{ ...SaveStyle, width: 200, textAlign:'center' }}>
                   ...
                   <Typography variant='body1' component={'span'} sx={{margin:'10px 0 10px 0'}}>New staff registered successfully.</Typography>
